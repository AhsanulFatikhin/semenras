...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(). "index.php/admin/Instagram/insert_instagram" ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Instagram</label>
                    <input class="form-control form-control-lg" type="text" placeholder="nama instagram" name="nama_ig">
                  </div>
                  <div class="form-group">
