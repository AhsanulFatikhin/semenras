...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Konten Home</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(). "index.php/admin/home/update_home" ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Id Home</label>
                    <input class="form-control form-control-lg" type="text" id="usr" name="idhome" readonly value="<?php echo $idhome;?>">
                  </div>
                  <div class="form-group">
