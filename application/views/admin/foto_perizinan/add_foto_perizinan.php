...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Foto Perizinan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(). "index.php/admin/foto_perizinan/aksi_upload" ?>">
                    ...
                    <select class="form-control" name="idprofil">
                     <option disabled selected>-- Pilih Profil --</option>
                        <?php foreach ($profil as $data_profil) { ?>
                         <option  value="<?php echo $data_profil["idpabrik"] ;?>" selected=""><?php echo $data_profil["sejarah"] ;?></option>
                         <?php } ?>
                    </select>
                  </div>
                </div>
