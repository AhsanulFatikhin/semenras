...
<head>
  ...
  <link href="<?php echo site_url('https://fonts.googleapis.com/icon?family=Material+Icons') ?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/plugins/font-awesome/css/font-awesome.min.css') ?>" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link href="<?php echo base_url('https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css') ?>" rel="stylesheet">
  <!-- Theme style -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="#" class="d-block"><?php echo $current_user[0]->nama; ?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('admin/pegawai/pegawai') ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Pegawai</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo site_url('admin/product/product') ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Product</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo site_url('admin/pabrik/pabrik') ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Pabrik</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo site_url('admin/profil/profil') ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Profil</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('admin/project/project') ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Project</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('Home/logout/'.$current_user[0]->idadmin)?>" class="nav-link">
