...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(). "index.php/admin/pegawai/update_pegawai" ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Id Pegawai</label>
                    <input class="form-control form-control-lg" type="text" id="usr" name="idpegawai" readonly value="<?php echo $idpegawai;?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-lg" type="text" name="divisi" value="<?php echo $divisi;?>">
                  </div>
                <div class="form-group">
