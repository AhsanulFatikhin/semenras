...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(). "index.php/admin/product/insert_product" ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Product</label>
                    <input class="form-control form-control-lg" type="text" placeholder="nama product" name="nama">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Berat Product</label>
                    <input class="form-control form-control-lg" type="text" placeholder="berat product" name="berat">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Daya Rekat Product</label>
                    <input class="form-control form-control-lg" type="text" placeholder="daya rekat product" name="dayarekat">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Pengertian Product</label>
                    <input class="form-control form-control-lg" type="text" placeholder="pengertian product" name="pengertian">
                  </div>
                   <div class="form-group">
